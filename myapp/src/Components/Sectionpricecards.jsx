        ...
        <div className="row flex-md-nowrap" style={{ gap: 15 }}>
          ...
          >
            ...
            <p style={{ fontSize: 11, color: "white" }}>
              All features are included for the perfect <br /> headshot
            </p>
            <img src="assest/img/icon.png" style={{ width: "15px" }} alt="" />
            <span
              style={{ color: "white", fontSize: "11px", marginLeft: "10px" }}
            >
            ...
            <br />
            <img src="assest/img/cross.png" style={{ width: "15px" }} alt="" />
            <span
              style={{ color: "white", fontSize: "11px", marginLeft: "10px" }}
            >
              No human edits
